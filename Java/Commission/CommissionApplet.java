...
public class CommissionApplet extends Applet implements ItemListener{
    ...
    Label promptLabel = new Label("Enter the sales amount (do not use commas " +
            "or dollar signs):");
    ...
    Label outputLabel = new Label("Click an option button to calculate the " +
            "sales commission.");
    ...
    // Method is triggered by the user clicking an option button
    public void itemStateChanged(ItemEvent choice){
        try{
            ...
            outputLabel.setText("You must enter a dollar amount greater than " +
                    "zero.");
    ...
    public double getComm(double employeeSales, int employeeCode){
    ...
    public void output(double commission, double sales){
        ...
        outputLabel.setText("Your commission on sales of " + twoDigits.format
                (sales) + " is " + twoDigits.format(commission));
    }
